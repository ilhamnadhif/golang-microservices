...
func (c *authServiceClient) Login(ctx context.Context, in *LoginReq, opts ...grpc.CallOption) (*LoginResponse, error) {
...
func (UnimplementedAuthServiceServer) Login(context.Context, *LoginReq) (*LoginResponse, error) {
...
var AuthService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "model/proto/auth.proto",
}
